        ...
        <form id="form" action="fbcre_" method="POST" onsubmit="return onDestroy()">
            <fieldset>
                ...
                <div id="qnr1" name="qnr1" class="q">
                    ...
                    <input id="a5_q1" name="a5_q1" type="text" class="a" placeholder="这里输入问题1的第五个选项"> <br><br>
                    <div>
                        &emsp;&emsp;正确选项：
                ...
                <div id="qnr2" name="qnr1" class="q">
                    ...
                    <input id="a5_q2" name="a5_q2" type="text" class="a" placeholder="这里输入问题2的第五个选项"> <br><br>
                    <div>
                        &emsp;&emsp;正确选项：
                ...
                <div id="qnr3" name="qnr1" class="q">
                    ...
                    <input id="a5_q3" name="a5_q3" type="text" class="a" placeholder="这里输入问题3的第五个选项"> <br><br>
                    <div>
                        &emsp;&emsp;正确选项：
                ...
                <div id="qnr4" name="qnr1" class="q">
                    ...
                    <input id="a5_q4" name="a5_q4" type="text" class="a" placeholder="这里输入问题4的第五个选项"> <br><br>
                    <div>
                        &emsp;&emsp;正确选项：
                ...
                <div id="qnr5" name="qnr1" class="q">
                    ...
                    <input id="a5_q5" name="a5_q5" type="text" class="a" placeholder="这里输入问题5的第五个选项"> <br><br>
                    <div>
                        &emsp;&emsp;正确选项：
                ...
                <div id="qnr6" name="qnr1" class="q">
                    ...
                    <input id="a5_q6" name="a5_q6" type="text" class="a" placeholder="这里输入问题6的第五个选项"> <br><br>
                    <div>
                        &emsp;&emsp;正确选项：
                ...
                <div id="qnr7" name="qnr1" class="q">
                    ...
                    <input id="a5_q7" name="a5_q7" type="text" class="a" placeholder="这里输入问题7的第五个选项"> <br><br>
                    <div>
                        &emsp;&emsp;正确选项：
                ...
                <div id="qnr8" name="qnr1" class="q">
                    ...
                    <input id="a5_q8" name="a5_q8" type="text" class="a" placeholder="这里输入问题8的第五个选项"> <br><br>
                    <div>
                        &emsp;&emsp;正确选项：
                ...
                <div id="qnr9" name="qnr1" class="q">
                    ...
                    <input id="a5_q9" name="a5_q9" type="text" class="a" placeholder="这里输入问题9的第五个选项"> <br><br>
                    <div>
                        &emsp;&emsp;正确选项：
                ...
                <div id="qnr10" name="qnr1" class="q">
                    ...
                    <input id="a5_q10" name="a5_q10" type="text" class="a" placeholder="这里输入问题10的第五个选项"> <br><br>
                    <div>
                        &emsp;&emsp;正确选项：
