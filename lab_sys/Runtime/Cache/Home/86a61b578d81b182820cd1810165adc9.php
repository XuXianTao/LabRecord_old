...
<body onload="init()">
    ...
    <div id="main">
        <form id="login" action="/index.php/Home/Login/log_" method="POST">
            <p>请输入学号：</p><input name="id" type="text"><br>
